...
class Category extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('blog/categorylist', $data);
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run()==FALSE) {
            $this->load->view('blog/input_category');
        }else {
            $this->category_model->insertCategory();
            $this->load->view('blog/sukses_input_category');
        }
    }
    public function update($id) {
        ...
        if ($this->form_validation->run()==FALSE) {
            $this->load->view('blog/edit_category', $data);
        }else {
            $this->category_model->updateById($id);
            $this->load->view('blog/sukses_edit_category');
        }
    }
    ...
    public function delete($id) {
        ...
        $this->load->view('blog/sukses_delete_category');
    }
}
