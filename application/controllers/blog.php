...
class Blog extends CI_Controller {
	public function index() {
    	...
    	$this->load->view('blog/postlist', $data);
    ...
    public function read($id)
    {
        ...
        $this->load->view('blog/postread', $data);
	...
	public function create()
	{
    	...
    	if ($this->form_validation->run()==FALSE) {
    		...
    		$this->load->view('blog/input_post', $data);
    	}else {
    		$this->blog_model->insertPost();
    		$this->load->view('blog/sukses_input');
    	}
	}
	 ...
	 public function update($id) {
    	...
    	if ($this->form_validation->run()==FALSE) {
    		...
    		$this->load->view('blog/sukses_edit');
    	}
    }
    ...
    public function delete($id) {
    	...
    	$this->load->view('blog/sukses_delete');
    }
}